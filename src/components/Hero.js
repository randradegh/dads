        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <Star className="w-5 h-5 text-unam-gold" />
                <span className="text-unam-gold font-semibold">Programa de Excelencia</span>
              </div>
            ...
            <div className="grid grid-cols-3 gap-6 py-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-unam-gold">30</div>
                <div className="text-sm text-blue-200">Créditos</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-unam-gold">240</div>
          ...
          <div className="relative">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
              <img 
                src="/hero-image.jpg" 
                alt="Estudiantes en auditorio tipo maestría de Harvard" 
                className="w-full h-auto rounded-xl shadow-2xl"
              />
            </div>
            
            {/* Floating Elements */}
            <div className="absolute -top-4 -right-4 bg-unam-gold rounded-full p-3 shadow-lg">
              <Star className="w-6 h-6 text-unam-blue" />
            </div>
            <div className="absolute -bottom-4 -left-4 bg-white/20 backdrop-blur-sm rounded-full p-3 shadow-lg">
